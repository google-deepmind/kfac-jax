...
class Optimizer(utils.WithStagedMethods):
  ...
  def _maybe_apply_norm_constraint(
    ...
    preconditioned_gradient = utils.scalar_mul(
        preconditioned_grads, coefficient)
    return sq_norm_scaled_grads, preconditioned_gradient
  ...
  def _step(
    ...
    # constrain the norms
    sq_norm_scaled_grads, preconditioned_gradient = (
        self._maybe_apply_norm_constraint(
            grads=grads,
            preconditioned_grads=preconditioned_gradient,
